...
@WebFilter(filterName = "FilterAutenticacao", urlPatterns = {"/*"})
public class FilterAutenticacao implements Filter {
    ...
    private void doBeforeProcessing(RequestWrapper request, ResponseWrapper response)
        ...
        if (debug) {
            log("FilterAutenticacao:DoBeforeProcessing");
        }
    ...
    private void doAfterProcessing(RequestWrapper request, ResponseWrapper response)
            throws IOException, ServletException {
        if (debug) {
            log("FilterAutenticacao:DoAfterProcessing");
        }
    ...
    public String toString() {
        if (filterConfig == null) {
            return ("FilterAutenticacao()");
        }
        StringBuffer sb = new StringBuffer("FilterAutenticacao(");
    ...
    class RequestWrapper extends HttpServletRequestWrapper {
        ...
        public void setParameter(String name, String[] values) {
            if (debug) {
                System.out.println("FilterAutenticacao::setParameter(" + name + "=" + values + ")" + " localParams = " + localParams);
            }
        ...
        public String getParameter(String name) {
            if (debug) {
                System.out.println("FilterAutenticacao::getParameter(" + name + ") localParams = " + localParams);
            }
            if (localParams == null) {
        ...
        public String[] getParameterValues(String name) {
            if (debug) {
                System.out.println("FilterAutenticacao::getParameterValues(" + name + ") localParams = " + localParams);
            }
            if (localParams == null) {
        ...
        public Enumeration getParameterNames() {
            if (debug) {
                System.out.println("FilterAutenticacao::getParameterNames() localParams = " + localParams);
            }
            if (localParams == null) {
        ...
        public Map getParameterMap() {
            if (debug) {
                System.out.println("FilterAutenticacao::getParameterMap() localParams = " + localParams);
            }
            if (localParams == null) {
